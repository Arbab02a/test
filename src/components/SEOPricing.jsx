    ...
    <section className="text-gray-400 body-font overflow-hidden">
      <div className="container px-5 pb-8 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <motion.h2
            className="text-4xl text-[#00024A] font-extrabold title-font -mb-6 mt-12"
...
const PricingCard = ({ title, price, features, buttonText, buttonStyle }) => {
  ...
  return (
    ...
    >
      <div className="h-full p-6 rounded-lg bg-[#00024A] flex flex-col relative overflow-hidden border-gray-700">
