...
<motion.h2
  className="text-4xl font-extrabold text-[#00024A] title-font -mb-6 mt-12"
  ...
  Web Design & Development
        ...
        <div className="flex flex-wrap -m-4">
          ...
          <PricingCard
            ...
            buttonText="Order Now"
            buttonStyle="bg-gray-700 hover:bg-gray-700"
            footerText="Literally you probably haven't heard of them jean shorts."
          />
          <PricingCard
...
const PricingCard = ({ title, price, features, badge, buttonText, buttonStyle, footerText }) => {
  ...
  return (
    ...
    >
    <motion.div
      className={`h-full p-6 rounded-lg flex flex-col bg-[#00024A] relative overflow-hidden  hover:cursor-pointer  ${badge ? "border-indigo-500" : "border-gray-700"}`}
    ...
    >
      ...
      <a href="mailto:info@virtualcrafterstek.com">
