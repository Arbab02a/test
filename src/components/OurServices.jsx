...
const OurServices = () => {
  return (
    <div className="container mx-auto p-10 bg-[#C6C6D2] text-gray-400">
      <motion.h2 
        className="text-4xl sm:text-5xl md:text-6xl font-bold text-center my-12 text-[#00024A]"
      ...
      <motion.p 
        className="font-semibold sm:text-xl md:text-xl leading-relaxed mb-8 sm:mb-12 text-[#00024A] text-center"
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
      >
...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    <motion.div
      className="p-6 bg-[#00024A] rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 hover:cursor-pointer"
      initial={{ opacity: 0, y: 50 }}
      animate={{ opacity: 1, y: 0 }}
