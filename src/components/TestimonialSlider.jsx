...
const TestimonialSlider = () => {
  ...
  return (
    <section className="bg-[#C6C6D2] py-16">
      <div className="container mx-auto px-5">
        <h2 className="text-5xl font-extrabold mb-4 sm:mb-6 text-[#00024A] text-center  leading-tight">Our Testimonials</h2>
        <p className="text-lg font-semibold text-[#00024A] text-center">
           What Our Clients Say?
          </p>
        <Slider {...settings}>
          {testimonials.map((testimonial, index) => (
            <div key={index} className="p-4">
              <div className="bg-[#00024A] p-6 rounded-lg shadow-lg text-center">
                {/* <img
