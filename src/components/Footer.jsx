...
const Footer = () => {
  return (
    <footer className="bg-[#00024A] text-gray-200  py-10">
      <div className="container mx-auto px-6 sm:px-8 md:px-12 lg:px-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div>
          <h3 className="text-lg font-bold mb-4">Contact Us</h3>
           <a href="mailto:info@virtualcrafterstek.com"><p className="mb-2">Email: info@virtualcrafterstek.com</p></a>
          ...
          <div className="flex space-x-4 mt-4">
            ...
            <a href="https://www.facebook.com/profile.php?id=61559447247176" target="_blank" className="transition-all hover:scale-110">
            <FaFacebook className=" w-10 h-10 mb-3 inline-block" />
            </a>
            <a href="https://www.instagram.com/virtual_crafter" target="_blank" className="transition-all hover:scale-110">
            <FaInstagramSquare className=" w-10 h-10 mb-3 inline-block" />
            </a>
            <a href="https://www.linkedin.com/in/virtual-crafters-b15a17332/" target="_blank" className="transition-all hover:scale-110">
