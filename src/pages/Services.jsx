...
import LogoPricing from '../components/LogoPricing.jsx';
import SocialMediaPricing from '../components/SocialMediaPricing.jsx';
import SEOPricing from '../components/SEOPricing.jsx';
...
const Services = () => {
  ...
  return (
    <section className="bg-[#C6C6D2] text-[#00024A]  body-font py-[8rem] px-5 lg:px-20">
        <motion.h1
  className="text-5xl text-center mb-10 -mt-4 sm:text-5xl md:text-6xl font-bold  title-font my-4"
        ...
        <button
          className={`px-6 py-3 rounded-full font-semibold transition-all duration-300 ease-in-out transform ${
            selectedService === 'Logo'
              ? 'bg-gradient-to-r from-[#000319] to-[#424574] text-white scale-105 shadow-lg'
              : 'bg-gradient-to-r from-[#000319] to-[#2c2f59] text-white  hover:bg-gray-700 hover:scale-105'
          }`}
