...
const FormWithStats = () => {
  ...
  return (
    <motion.div
      ...
      className="container mx-auto py-28 px-5 bg-[#C6C6D2]"
    >
      <div className="text-center mb-12">
        <motion.h2
          className="text-3xl text-[#00024A] sm:text-4xl md:text-5xl font-bold mb-8"
          initial={{ opacity: 0, y: -50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <p className="lg:w-2/3 mx-auto leading-relaxed font-bold text-[#00024A]">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <motion.form
          ...
          className="flex flex-col bg-[#00024A] gap-4 w-full md:w-1/2 border-2 border-gray-300 p-8 rounded-lg shadow-lg"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.3 }}
        >
          <div className="flex flex-col gap-3">
            <label className="text-lg text-white" htmlFor="fullname">
          ...
          <div className="flex flex-col gap-3">
            <label className="text-lg text-white" htmlFor="phone">
        ...
        {/* Stats */}
        <section className="text-gray-400 bg-[#C6C6D2] w-full md:w-1/2">
          <div className="container px-5 mx-auto">
            ...
            >
              <h1 className="text-5xl font-bold title-font text-[#00024A] mb-4">
                📊  Let's Talk
              </h1>
              <p className="text-lg text-[#00024A] text-gray-400">Social Media Presence & Website Visitors</p>
            </motion.div>
            ...
            <div className="flex flex-wrap font-medium -m-4 text-center" ref={ref}>
              {statsData.map((stat, index) => (
                ...
                >
                  <a href={stat.reference} target='_blank' rel='noopener noreferrer'>
                    <motion.div
                      className="px-4 py-8 bg-[#00024A] rounded-lg hover:shadow-lg hover:scale-105 transform transition-all duration-300 ease-in-out hover:cursor-pointer"
